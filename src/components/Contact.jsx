        ...
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-slate-400 text-sm max-w-xl mx-auto">
                    Hover over any panel to expand channel details and direct action links.
                </p>
            </div>
            ...
            <div className="accordion-wrapper bg-slate-950 p-2 lg:p-3 rounded-3xl border border-slate-800 shadow-2xl">
                ...
                <div className={`accordion-panel ${activePanel === 0 ? "active" : ""} bg-slate-900 text-white border border-slate-800`} onClick={() => setActivePanel(0)}>
                ...
                {/* Panel 2: Phone */}
                <div className={`accordion-panel ${activePanel === 1 ? "active" : ""} bg-blue-600 text-white border border-blue-500`} onClick={() => setActivePanel(1)}>
                    {/* Collapsed Content (Desktop) */}
                    <div className="collapsed-content hidden lg:flex flex-col items-center justify-between h-full absolute inset-0 py-8 px-2 pointer-events-none">
                ...
                {/* Panel 3: LinkedIn */}
                <div className={`accordion-panel ${activePanel === 2 ? "active" : ""} bg-sky-500 text-white border border-sky-400`} onClick={() => setActivePanel(2)}>
                    {/* Collapsed Content (Desktop) */}
                    <div className="collapsed-content hidden lg:flex flex-col items-center justify-between h-full absolute inset-0 py-8 px-2 pointer-events-none">
                ...
                {/* Panel 4: WhatsApp */}
                <div className={`accordion-panel ${activePanel === 3 ? "active" : ""} bg-emerald-600 text-white border border-emerald-500`} onClick={() => setActivePanel(3)}>
                    {/* Collapsed Content (Desktop) */}
                    <div className="collapsed-content hidden lg:flex flex-col items-center justify-between h-full absolute inset-0 py-8 px-2 pointer-events-none">
                ...
                {/* Panel 5: Email */}
                <div className={`accordion-panel ${activePanel === 4 ? "active" : ""} bg-amber-400 text-slate-950 border border-amber-300`} onClick={() => setActivePanel(4)}>
                    {/* Collapsed Content (Desktop) */}
                    <div className="collapsed-content hidden lg:flex flex-col items-center justify-between h-full absolute inset-0 py-8 px-2 pointer-events-none">
